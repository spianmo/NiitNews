 ...
 * @Project:NiitNews
 * @Author:Finger
 * @FileName:AudioWaveSurfaceView.java
 ...
 * @author Michael Lee
 */
public class AudioWaveSurfaceView extends SurfaceView
    ...
    public AudioWaveSurfaceView(Context context) {
        super(context);
        initView();
    }
    ...
    public AudioWaveSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.AudioWaveSurfaceView);
        audioSampleNum = typedArray.getInteger(R.styleable.AudioWaveSurfaceView_audioTotal, audioSampleNum);
        color = typedArray.getColor(R.styleable.AudioWaveSurfaceView_strokeColor, color);
        strokeWidth = typedArray.getDimension(R.styleable.AudioWaveSurfaceView_strokeWidth, strokeWidth);
        autoControl = typedArray.getBoolean(R.styleable.AudioWaveSurfaceView_autoControl, true);
        int sampleRate = typedArray.getInteger(R.styleable.AudioWaveSurfaceView_sampleRate, 44100);
        int frame = typedArray.getInteger(R.styleable.AudioWaveSurfaceView_animationFrame, 30);
