...
public class AudioWaveView extends View {
    ...
    public AudioWaveView(Context context, AttributeSet attrs) {
        ...
        int color = typedArray.getColor(R.styleable.AudioWaveView_waveColor, Color.parseColor("#BF1ae8c9"));
        int strokeWidth = (int) typedArray.getDimension(R.styleable.AudioWaveView_waveWidth, 1);
        audioSampleNum = typedArray.getInteger(R.styleable.AudioWaveView_pointTotal, audioSampleNum);
        accuracy = typedArray.getInteger(R.styleable.AudioWaveView_accuracy, accuracy);
        readCount = typedArray.getInteger(R.styleable.AudioWaveView_readCount, readCount);
