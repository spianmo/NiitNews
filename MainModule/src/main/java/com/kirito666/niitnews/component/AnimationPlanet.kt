 ...
 * @Author:Finger
 * @FileName:AnimationPlanet.kt
 * @LastModified:2021/04/12 22:23:12
 */
...
class AnimationPlanet : View {
    ...
    var baseR = 200F
    var viewBackgroundColor = 0xFF323232.toInt()   //背景颜色
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val heitht = MeasureSpec.getSize(heightMeasureSpec)
        //设置当前的背景高和宽为整个组件
        if (viewWidth == 0F) {
    ...
    private fun drawGas(canvas: Canvas, index: Float) {
        ...
        val paintArc = Paint()
        paintArc.color = 0xff311B92.toInt()
